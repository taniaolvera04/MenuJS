var productos=["Kinder","Pepper","Takis","Vuala","Yakult", "Lucas", "Coca", "Nescafe"];
var precios=[23, 20, 17, 20, 7, 10, 25, 40];
...
agregarCarrito.onclick=()=>{
    ...
    //si es verdadero el if, va a volver a imprimir tabla, sumándole la cantidad de producto que agregó el cliente
...
const imprimirTabla=()=>{
    ...
    let tablaHTML=`<table class="table w-100 m-auto">
        ...
        carrito.forEach(item=>{
            ...
            <td><button class="btn btn-danger" onclick="eliminarProducto(${index})"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
